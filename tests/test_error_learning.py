...
class ErrorLearningTests(unittest.TestCase):
    ...
    def test_add_command_persists_schema_and_deduplicates(self) -> None:
        ...
        self.assertEqual(entry["context"], "session=batch-7")

    def test_add_requires_suggested_fix(self) -> None:
        ...
        self.assertIn("suggested_fix is required", stderr)
    ...
    def test_legacy_v1_entry_migrates_on_load(self) -> None:
        legacy = {
            "schema_version": 1,
            "entries": [
                {
